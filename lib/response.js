...
/**
 * Common header cache for performance optimization
 * Pre-build common response headers to avoid repeated string operations
 * @private
 */
...
res.json = function json(obj) {
  ...
  // content-type (use cached header for common case)
  if (!this.get('Content-Type')) {
    this.set('Content-Type', COMMON_HEADERS['application/json'] || 'application/json');
  }
